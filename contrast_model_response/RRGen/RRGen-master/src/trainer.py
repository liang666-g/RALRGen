...
def train(src_sents, tgt_sents, src_seqs, tgt_seqs, src_lens, tgt_lens, rate_sents, cate_sents, senti_sents, encoder, decoder, encoder_optim, decoder_optim, opts):
    ...
    # Clip gradients
    encoder_grad_norm = nn.utils.clip_grad_norm_(encoder.parameters(), opts.max_grad_norm)
    decoder_grad_norm = nn.utils.clip_grad_norm_(decoder.parameters(), opts.max_grad_norm)
